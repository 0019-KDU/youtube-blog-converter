...
class TestTasks:
    ...
    def test_create_tasks_success(self, mock_logger, mock_task_class):
        ...
        mock_logger.info.assert_called_with("Enhanced tasks created successfully")
    ...
    def test_task_configuration_parameters(self, mock_logger, mock_task_class):
        ...
        assert "Complete transcript with ALL specific tool names" in transcript_kwargs['expected_output']
    ...
    def test_task_context_relationship(self, mock_logger, mock_task_class):
        ...
        create_tasks(mock_transcriber, mock_writer, "https://youtube.com/test", "en")
    ...
    def test_create_tasks_with_different_languages(self, mock_logger):
        ...
        with patch('app.crew.tasks.Task') as mock_task_class:
            ...
            for lang in test_languages:
                create_tasks(mock_transcriber, mock_writer, "https://youtube.com/test", lang)
    ...
    def test_create_tasks_parameter_validation(self):
        ...
        with patch('app.crew.tasks.Task') as mock_task_class:
            ...
            # The function should validate parameters before accessing attributes
            try:
                ...
                pytest.fail("Function should validate parameters before accessing attributes")
