...
class TestSecurity:
    ...
    def test_get_current_user_with_bearer_token(
            self, request_context, mock_mongodb_globally):
    ...
    def test_get_current_user_with_session_token(
            self, request_context, mock_mongodb_globally):
    ...
    def test_get_current_user_with_user_id(
            self, request_context, mock_mongodb_globally):
    ...
    def test_cleanup_old_storage(self, app_context):
        ...
        current_app.temp_storage.update({
            ...
            # 2 hours ago
            'old_data': {'data': 'old', 'timestamp': current_time - 7200}
        })
    ...
    def test_get_current_user_jwt_decode_error(
            self, request_context, mock_mongodb_globally):
    ...
    def test_get_current_user_sets_g_user_id(
            self, request_context, mock_mongodb_globally):
    ...
    def test_get_current_user_cleanup_on_failure(
            self, request_context, mock_mongodb_globally):
