    ...
    def _manual_transcript_fallback(self, video_id, language="en"):
        ...
        try:
            ...
            try:
                ...
                caption = yt.captions[language] or yt.captions['en'] or yt.captions['a.en'] or list(yt.captions.all())[0]
