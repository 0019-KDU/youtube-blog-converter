    ...
    try:
        ...
        health_data = {
            ...
            'application': {
                ...
                'uptime_seconds': int(time.time() - current_app.start_time) if hasattr(current_app, 'start_time') else 0
            }
        }
...
def health_metrics():
    ...
    try:
        ...
        metrics.append(f'app_uptime_seconds {int(time.time() - current_app.start_time) if hasattr(current_app, "start_time") else 0}')
